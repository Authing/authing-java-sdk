...
public class ManagementClientTest {
    ...
    public void getResourceTest () {
        ...
        request.setCode("code_5070");
        request.setNamespace("namespace_2324");
    ...
    public void removeDepartmentMembersTest () {
        ...
        request.setUserIds(Collections.singletonList("String_8237"));
    ...
    public void deketeNamespacesBatchTest () {
        ...
        request.setCodeList(Collections.singletonList("String_9663"));
    ...
    public void deleteResourcesBatchTest () {
        ...
        request.setCodeList(Collections.singletonList("String_3317"));
    ...
    public void getTargetAuthorizedResourcesTest () {
        ...
        request.setTargetIdentifier("targetIdentifier_1457");
    ...
    public void getUserLoginHistoryTest () {
        ...
        request.setAppId("appId_2704");
        request.setClientIp("clientIp_9827");
        request.setStart(0);
        request.setEnd(0);
    ...
    public void getManagementTokenTest () {
        ...
        request.setSecret("secret_197");
        request.setUserPoolId("userPoolId_1894");
    ...
    public void getUserBatchTest () {
        ...
        request.setUserIds(Collections.singletonList("String_10"));
        request.setOptions(new dto.GetUserOptionsDto());
    ...
    public void createExtIdpTest () {
        ...
        request.setTenantId("tenantId_3834");
    ...
    public void getNamespacesBatchTest () {
        ...
        request.setCodeList(Collections.singletonList("String_5340"));
    ...
    public void addGroupMembersTest () {
        ...
        request.setUserIds(Collections.singletonList("String_6058"));
    ...
    public void isUserExistsTest () {
        ...
        request.setUsername("username_2022");
        request.setEmail("email_3619");
        request.setPhone("phone_7765");
        request.setExternalId("externalId_5499");
    ...
    public void kickUsersTest () {
        ...
        request.setAppIds(Collections.singletonList("String_3142"));
    ...
    public void getResourcesBatchTest () {
        ...
        request.setCodeList(Collections.singletonList("String_7637"));
    ...
    public void deleteGroupsTest () {
        ...
        request.setCodeList(Collections.singletonList("String_326"));
    ...
    public void deleteUserBatchTest () {
        ...
        request.setUserIds(Collections.singletonList("String_4186"));
    ...
    public void deleteRolesTest () {
        ...
        request.setCodeList(Collections.singletonList("String_2663"));
    ...
    public void removeGroupMembersTest () {
        ...
        request.setUserIds(Collections.singletonList("String_1873"));
    ...
    public void changeConnStateTest () {
        ...
        request.setTenantId("tenantId_790");
