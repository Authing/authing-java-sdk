...
public class CreateApplicationTest {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        request.setAppName("appName_2327");
        request.setTemplate("template_3308");
        request.setTemplateData("templateData_3692");
        request.setAppIdentifier("appIdentifier_7704");
        request.setAppLogo("appLogo_4911");
        request.setAppDescription("appDescription_2725");
        ...
        request.setRedirectUris(Collections.singletonList("String_2224"));
        request.setLogoutRedirectUris(Collections.singletonList("String_6310"));
        request.setInitLoginUri("initLoginUri_1960");
