...
public class GetAdminAuditLogsTest {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        request.setRequestId("requestId_8605");
        request.setClientIp("clientIp_5235");
        request.setOperationType("operationType_9607");
        request.setResourceType("resourceType_4982");
        request.setUserId("userId_2228");
