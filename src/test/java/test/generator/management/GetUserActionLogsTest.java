...
public class GetUserActionLogsTest {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        request.setRequestId("requestId_6575");
        request.setClientIp("clientIp_1561");
        request.setEventType("eventType_1339");
        request.setUserId("userId_5248");
        request.setAppId("appId_8607");
        request.setStart(0);
        request.setEnd(0);
