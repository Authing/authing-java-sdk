...
public class ListDepartmentMembersTest {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        request.setOrganizationCode("organizationCode_9484");
        request.setDepartmentId("departmentId_2430");
        request.setDepartmentIdType("departmentIdType_5902");
        ...
        request.setSortBy("sortBy_755");
        request.setOrderBy("orderBy_6988");
