...
public class GetNewAccessTokenByRefreshTokenTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        clientOptions.setTokenEndPointAuthMethod(AuthMethodEnum.NONE.getValue());
        AuthenticationClient client = new AuthenticationClient(clientOptions);

        OIDCTokenResponse oidcTokenResponse = client.getAccessTokenByCode("");
        GetNewAccessTokenByRefreshTokenRespDto response = client.getNewAccessTokenByRefreshToken(oidcTokenResponse.getRefreshToken());
