...
public class CreateApplicationTest {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        request.setAppName("appName_2635");
        request.setTemplate("template_4755");
        request.setTemplateData("templateData_5177");
        request.setAppIdentifier("appIdentifier_593");
        request.setAppLogo("appLogo_1044");
        request.setAppDescription("appDescription_164");
        ...
        request.setRedirectUris(Collections.singletonList("String_1374"));
        request.setLogoutRedirectUris(Collections.singletonList("String_9138"));
        request.setInitLoginUri("initLoginUri_6656");
