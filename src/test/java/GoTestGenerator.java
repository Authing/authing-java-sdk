...
public class GoTestGenerator {
    ...
    public static void main(String[] args) throws Throwable{
        ...
        // write
        FileReader fileReader = new FileReader(new File("D:\\Work\\Java_\\Workspace\\Authing\\authing-java-sdk-v5\\src\\test\\java\\resources\\go_template.ftl"));
        FileWriter fileWriter = new FileWriter(new File("D:\\Work\\Java_\\Workspace\\Authing\\authing-java-sdk-v5\\src\\test\\go\\test\\go_test.go"));
        
        FreeMarkerUtils.process(fileReader, fileWriter, testTemplate, "go_test");
