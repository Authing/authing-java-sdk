...
import cn.genauth.sdk.java.dto.authentication.CaptchaCodeRespDto;
import cn.genauth.sdk.java.dto.authentication.CodeChallengeDigestParam;
import cn.genauth.sdk.java.dto.authentication.CodeToTokenParams;
import cn.genauth.sdk.java.dto.authentication.ICasParams;
import cn.genauth.sdk.java.dto.authentication.IDToken;
import cn.genauth.sdk.java.dto.authentication.IOauthParams;
import cn.genauth.sdk.java.dto.authentication.IOidcParams;
import cn.genauth.sdk.java.dto.authentication.OIDCTokenResponse;
import cn.genauth.sdk.java.dto.authentication.UserInfo;
import cn.genauth.sdk.java.dto.authentication.ValidateTicketV1Response;
...
import cn.genauth.sdk.java.model.ClientCredentialInput;
import cn.genauth.sdk.java.model.Receiver;
import cn.genauth.sdk.java.util.CommonUtils;
import cn.genauth.sdk.java.util.HttpUtils;
 ...
 * [
     * {
         ...
         * {
             ...
             **/
            public LoginTokenRespDto switchLoginByUser(PublicAccountSwitchLoginDto reqDto) {
                AuthingRequestConfig config = new AuthingRequestConfig();
                config.setUrl("/api/v3/switch-login-by-user");
                config.setBody(reqDto);
                config.setMethod("POST");
                String response = request(config);
                return deserialize(response, LoginTokenRespDto.class);
             ...
             **/
            public GetWechatAccessTokenInfoRespDto getWechatMpAccessTokenInfo(GetWechatAccessTokenDto reqDto) {
                AuthingRequestConfig config = new AuthingRequestConfig();
             ...
             **/
            public GetPublicAccountDataRespDto listPublicAccountsForSwitchLoggedIn(GetUserSelectLoginPublicAccountsDto reqDto) {
                AuthingRequestConfig config = new AuthingRequestConfig();
                config.setUrl("/api/v3/get-user-select-login-public-accounts");
                config.setBody(reqDto);
                config.setMethod("GET");
                String response = request(config);
                return deserialize(response, GetPublicAccountDataRespDto.class);
            }
            /**
             * @summary 获取服务器公开信息
             ...
             **/
            public GetUserAuthResourcePermissionListRespDto getUserAuthResourcePermissionList(GetUserAuthResourcePermissionListDto reqDto) {
                AuthingRequestConfig config = new AuthingRequestConfig();
             ...
             **/
            public GetUserAuthResourceStructRespDto getUserAuthResourceStruct(GetUserAuthResourceStructDto reqDto) {
                AuthingRequestConfig config = new AuthingRequestConfig();
             ...
             **/
            public TerminalSessionRespDto list(ListDto reqDto) {
                AuthingRequestConfig config = new AuthingRequestConfig();
                config.setUrl("/api/v3/mydevices/list");
                config.setBody(reqDto);
                config.setMethod("GET");
                String response = request(config);
                return deserialize(response, TerminalSessionRespDto.class);
            }
            /**
             * @summary 移除设备
             * @description 移除某个设备。
             **/
            public CommonResponseDto unbind(UnbindDeviceDto reqDto) {
                AuthingRequestConfig config = new AuthingRequestConfig();
                config.setUrl("/api/v3/mydevices/unbind");
                config.setBody(reqDto);
                config.setMethod("POST");
                String response = request(config);
                return deserialize(response, CommonResponseDto.class);
             ...
             **/
            public CommonResponseDto revoke(RevokeDeviceSessionDto reqDto) {
                AuthingRequestConfig config = new AuthingRequestConfig();
                config.setUrl("/api/v3/mydevices/revoke-session");
                config.setBody(reqDto);
                config.setMethod("POST");
                String response = request(config);
                return deserialize(response, CommonResponseDto.class);
            ...
            /**
             **/
            public ListWebAuthnAuthenticatorDeviceDataDto listCredentialsByPage(ListDeviceCredentialDto reqDto) {
                AuthingRequestConfig config = new AuthingRequestConfig();
                config.setUrl("/api/v3/webauthn/page-authenticator-device");
                config.setBody(reqDto);
                config.setMethod("POST");
                String response = request(config);
                return deserialize(response, ListWebAuthnAuthenticatorDeviceDataDto.class);
            }
            /**
             **/
            public WebAuthnCheckValidCredentialsByCredIdsRespDto checkValidCredentialsByCredIds(CheckDeviceCredentialIdDto reqDto) {
                AuthingRequestConfig config = new AuthingRequestConfig();
                config.setUrl("/api/v3/webauthn/check-valid-credentials-by-credIds");
                config.setBody(reqDto);
                config.setMethod("POST");
                String response = request(config);
                return deserialize(response, WebAuthnCheckValidCredentialsByCredIdsRespDto.class);
            }
            /**
             **/
            public IsSuccessRespDto removeAllCredentials(RemoveDeviceCredentialDto reqDto) {
                AuthingRequestConfig config = new AuthingRequestConfig();
            ...
            /**
             **/
            public IsSuccessRespDto removeCredential(WebAuthnRemoveCredentialDto reqDto) {
                AuthingRequestConfig config = new AuthingRequestConfig();
