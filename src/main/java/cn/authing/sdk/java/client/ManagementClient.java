...
public class ManagementClient extends BaseClient {
   ...
   * 筛选在某一段时间内登录过的用户：
   * <p>
   * ```json { "advancedFilter": [ { "field": "lastLogin", "operator": "BETWEEN", "value": [
   * Date.now() - 14 * 24 * 60 * 60 * 1000, Date.now() - 7 * 24 * 60 * 60 * 1000 ] } ] } ```
   * <p>
   * #### 根据用户曾经登录过的应用筛选
   * <p>
   * 筛选出曾经登录过应用 `appId1` 或者 `appId2` 的用户：
   * <p>
   * ```json { "advancedFilter": [ { "field": "loggedInApps", "operator": "IN", "value": [ "appId1",
   * "appId2" ] } ] } ```
   * <p>
   * #### 根据用户所在部门进行筛选
   * <p>
  ...
  /**
   * @summary 创建用户
   * @description 创建用户，邮箱、手机号、用户名必须包含其中一个，邮箱、手机号、用户名、externalId
   * 用户池内唯一，此接口将以管理员身份创建用户因此不需要进行手机号验证码检验等安全检测。
   **/
  ...
  /**
   * @summary 批量创建用户
   * @description 批量创建用户，邮箱、手机号、用户名必须包含其中一个，邮箱、手机号、用户名、externalId
   * 用户池内唯一，此接口将以管理员身份创建用户因此不需要进行手机号验证码检验等安全检测。
   **/
   ...
   **/
  public InviteTenantUsersRespDto generateInviteTenantUserLink(
      GenerateInviteTenantUserLink reqDto) {
    AuthingRequestConfig config = new AuthingRequestConfig();
   ...
   **/
  public InviteTenantUserRecordListRespDto listInviteTennatUserRecords(
      ListInviteTenantUserRecordsDto reqDto) {
    AuthingRequestConfig config = new AuthingRequestConfig();
   ...
   **/
  public MultipleTenantAdminPaginatedRespDto listMultipleTenantAdmin(
      ListMultipleTenantAdminsDto reqDto) {
    AuthingRequestConfig config = new AuthingRequestConfig();
   ...
   * @description 根据用户池 ID 获取某个用户池内拥有多租户管理权限的用户列表
   **/
  public MultipleTenantAdminPaginatedRespDto getMultipleTenantAdmin(
      GetMultipleTenantAdminDto reqDto) {
    AuthingRequestConfig config = new AuthingRequestConfig();
  ...
  public CommonResponseDto updateMultipleTenantAdmin(UpdateMultipleTenantAdminDto reqDto) {
    AuthingRequestConfig config = new AuthingRequestConfig();
    config.setUrl("/api/v3/update-multiple-tenant-admin");
    config.setBody(reqDto);
    config.setMethod("POST");
    String response = request(config);
    return deserialize(response, CommonResponseDto.class);
  ...
  public CommonResponseDto deleteMultipleTenantAdmin() {
    AuthingRequestConfig config = new AuthingRequestConfig();
    config.setUrl("/api/v3/delete-multiple-tenant-admin");
  ...
  public CommonResponseDto updateTenantCooperator(UpdateTenantCooperatorDto reqDto) {
    AuthingRequestConfig config = new AuthingRequestConfig();
    config.setUrl("/api/v3/update-tenant-cooperator");
    config.setBody(reqDto);
    config.setMethod("POST");
    String response = request(config);
    return deserialize(response, CommonResponseDto.class);
  ...
  public CommonResponseDto deleteTenantCooperator() {
    AuthingRequestConfig config = new AuthingRequestConfig();
    config.setUrl("/api/v3/delete-tenant-cooperator");
  ...
  /**
   * @summary 创建租户成员
   * @description 创建租户成员，邮箱、手机号、用户名必须包含其中一个，邮箱、手机号、用户名、externalId
   * 用户池内唯一，此接口将以管理员身份创建用户因此不需要进行手机号验证码检验等安全检测。
   **/
   ...
   * @description 通过部门 ID、组织 code，删除部门下成员。
   **/
  public IsSuccessRespDto removeTenantDepartmentMembers(
      RemoveTenantDepartmentMembersReqDto reqDto) {
    AuthingRequestConfig config = new AuthingRequestConfig();
  ...
  /**
   * @summary 创建数据资源
   * @description 该接口用于创建数据资源，通过数据资源所属权限空间 Code、数据资源名称、数据资源
   * Code、数据资源类型（STRING、ARRAY、TREE）以及数据操作列表进行创建, 通过不同的数据资源类型适配不同的场景。
   * <p>
   * ### 创建数据资源字符串类型示例
   * <p>
   ...
   * "resourceCode": "array1", "description": "这是一个数据资源数组类型创建", "type": "ARRAY", "struct":["array1",
   * "array2", "array3"], "actions": ["get","read","update"] } ```
   * <p>
   * ### 创建数据资源树类型示例
   * <p>
  ...
  /**
   * @summary 获取数据资源信息
   * @description 获取数据资源, 通过数据资源 ID 查询对应的数据资源信息,包含数据资源名称、数据资源
   * Code、数据资源类型（TREE、STRING、ARRAY）、数据资源所属权限空间 ID、数据资源所属权限空间 Code 以及数据资源操作列表等基本信息。
   **/
   ...
   * "934108e5-9fbf-4d24-8da1-c330328abd6c", "data": { "isValid": "false", "message": "data resource
   * code already exist" } } ```
   **/
   ...
   * "STRING", "strAuthorize": { "value": "示例字符串资源", "actions": [ "read", "post", "get", "write" ] }
   * } ] }, { "userId": "6121ceaxxxxxxxxxxx27312", "namespaceCode": "examplePermissionNamespace2",
   * "resourceList": [ { "resourceCode": "arrayCode", "resourceType": "ARRAY", "arrAuthorize": {
   * "values": [ "示例数组资源1", "示例数组资源2" ], "actions": [ "read", "post", "get", "write" ] } } ] } ] } }
   * ```
   * <p>
   ...
   * ```json { "statusCode": 200, "message": "操作成功", "apiCode": 20001, "data": {
   * "userPermissionList": [ { "userId": "6301ceaxxxxxxxxxxx27478", "namespaceCode":
   * "examplePermissionNamespace1", "resourceList": [ { "resourceCode": "strCode1", "resourceType":
   * "STRING", "strAuthorize": { "value": "示例字符串资源", "actions": [ "read", "post", "get", "write" ] }
   * } ] }, { "userId": "6121ceaxxxxxxxxxxx27312", "namespaceCode": "examplePermissionNamespace2",
   * "resourceList": [ { "resourceCode": "arrayCode", "resourceType": "ARRAY", "arrAuthorize": {
   * "values": [ "示例数组资源1", "示例数组资源2" ], "actions": [ "read", "post", "get", "write" ] } } ] } ] } }
   ...
   * "action": "get", "resources":["strResourceCode1", "arrayResourceCode1"] } ```
   * <p>
   * - 出参
   * <p>
   * ```json { "statusCode": 200, "message": "操作成功", "apiCode": 20001, "data": { "checkResultList":
   * [ { "namespaceCode": "examplePermissionNamespace", "resource": "strResourceCode1", "action":
   * "get", "enabled": true }, { "namespaceCode": "examplePermissionNamespace", "resource":
   * "arrayResourceCode1", "action": "get", "enabled": true } ] } } ```
   * <p>
   ...
   * ```json { "statusCode": 200, "message": "操作成功", "apiCode": 20001, "data": { "checkResultList":
   * [ { "namespaceCode": "examplePermissionNamespace", "resource": "strResourceCode1", "action":
   * "get", "enabled": false }, { "namespaceCode": "examplePermissionNamespace", "resource":
   * "arrayResourceCode1", "action": "get", "enabled": false } ] } } ```
   * <p>
   * ### 判断用户对树资源权限示例
   * <p>
   * - 入参
   * <p>
   * ```json { "namespaceCode": "examplePermissionNamespace", "userId": "63721xxxxxxxxxxxxdde14a3",
   * "action": "get", "resources":["treeResourceCode1/StructCode1/resourceStructChildrenCode1",
   ...
   * "namespaceCode": "examplePermissionNamespace", "actions": ["read","get"], "resource":
   * "strResourceCode1" },{ "namespaceCode": "examplePermissionNamespace", "actions":
   ...
   * <p>
   * ```json { "namespaceCode": "examplePermissionNamespace", "userId": "63721xxxxxxxxxxxxdde14a3",
   * "resources":["treeResourceCode1/StructCode1/resourceStructChildrenCode1",
   * "treeResourceCode2/StructCode1/resourceStructChildrenCode1"] } ```
   * <p>
   * - 出参
   * <p>
   * ```json { "statusCode": 200, "message": "操作成功", "apiCode": 20001, "data":{ "permissionList": [{
   * "namespaceCode": "examplePermissionNamespace", "actions": ["read", "update", "delete"],
   * "resource": "treeResourceCode1/StructCode1/resourceStructChildrenCode1" },{ "namespaceCode":
   * "examplePermissionNamespace", "actions": ["read", "get", "delete"], "resource":
   * "treeResourceCode2/StructCode1/resourceStructChildrenCode1" }] } } ```
   **/
   ...
   * "action": "get" },{ "userIds": ["63721xxxxxxxxxxxxdde14a3"], "action": "update" },{ "userIds":
   ...
   * "treeResourceCode2/StructCode1/resourceStructChildrenCode1", "actionAuthList": [{ "userIds":
   * ["63721xxxxxxxxxxxxdde14a3"], "action": "get" },{ "userIds": ["63721xxxxxxxxxxxxdde14a3"],
   * "action": "update" },{ "userIds": ["63721xxxxxxxxxxxxdde14a3"], "action": "delete" }] }] } }
   * ```
   **/
   ...
   * "treeResourceAuthAction":{ "nodeAuthActionList":[{ "code": "tree11", "name": "tree11", "value":
   * "test11Value", "actions": ["get","delete"], "children": [{ "code": "tree111", "name":
   * "tree111", "value": "test111Value", "actions": ["update","read"], }] },{ "code": "tree22",
   * "name": "tree22", "value": "test22Value", "actions": ["get","delete"] }] } } } ```
   **/
   ...
   * @description 该接口主要用于获取外部用户授权的资源列表，通过权限空间 Code、外部用户 Id、资源 Code
   * 获取外部用户资源的授权列表,通过不同的资源类型返回对应资源的授权。
   * <p>
   * <p>
   * ### 获取用户授权字符串数据资源示例
   * <p>
   ...
   * @description 该接口主要用于判断用户在树资源同层级下的权限，通过权限空间 Code 、用户
   * ID、资源操作、资源或资源子节点查询用户是否有该树资源同级路径的权限。可选传条件属性参数，默认不开启条件判断。
   * <p>
   * <p>
