...
public class ManagementClient extends BaseClient {
     ...
     **/
    public CommonResponseDto deleteMultipleTenantAdmin(DeleteMultipleTenantAdminBodyDto reqDto) {
        AuthingRequestConfig config = new AuthingRequestConfig();
     ...
     **/
    public CommonResponseDto deleteTenantCooperator(DeleteTenantCooperatorBodyDto reqDto) {
        AuthingRequestConfig config = new AuthingRequestConfig();
     ...
     **/
    public VerifyConfigInfoRespDto getVerifyConfig() {
        AuthingRequestConfig config = new AuthingRequestConfig();
        config.setUrl("/api/v3/verify-config");
        config.setBody(new Object());
        config.setMethod("GET");
        String response = request(config);
        return deserialize(response, VerifyConfigInfoRespDto.class);
    }
    /**
