...
import cn.authing.sdk.java.dto.OtpSecretRespDto;

public class GetOtpSecretRespDto {
    /**
    ...
    public OtpSecretRespDto getData() {
        return data;
    }
    public void setData(OtpSecretRespDto data) {
        this.data = data;
    }
