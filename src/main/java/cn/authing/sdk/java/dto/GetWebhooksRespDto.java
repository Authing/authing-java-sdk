...
import cn.authing.sdk.java.dto.GetWebhooksData;

public class GetWebhooksRespDto {
    /**
    ...
    public GetWebhooksData getData() {
        return data;
    }
    public void setData(GetWebhooksData data) {
        this.data = data;
    }
